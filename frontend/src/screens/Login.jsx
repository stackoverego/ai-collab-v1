    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 flex items-center justify-center px-4 py-10">
      <div className="w-full max-w-xl rounded-4xl border border-slate-800 bg-slate-900/95 p-10 shadow-[0_30px_90px_rgba(15,23,42,0.75)]">
        <div className="mb-10 text-center">
          <p className="text-sm uppercase tracking-[0.3em] text-cyan-400/80">Welcome back</p>
          <h1 className="mt-4 text-4xl font-semibold text-slate-50">Sign in to your account</h1>
